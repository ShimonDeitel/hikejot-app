...
/// Hikejot's own identity: a palette built specifically for this app's
/// domain, not a shared portfolio default.
enum AppTheme {
    static let backdrop = Color(red: 0.06, green: 0.08, blue: 0.06)
    static let card = Color.white
    static let cardBorder = Color(red: 0.3, green: 0.55, blue: 0.3).opacity(0.18)

    static let ink = Color(red: 0.12, green: 0.12, blue: 0.14)
    static let inkFaded = Color(red: 0.12, green: 0.12, blue: 0.14).opacity(0.56)

    static let accent = Color(red: 0.3, green: 0.55, blue: 0.3)
    static let accentDeep = Color(red: 0.3, green: 0.55, blue: 0.3).opacity(0.75)
